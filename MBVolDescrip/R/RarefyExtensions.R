#' A variety of approaches to rarefaction 
#' 
...
#' @param method One of "even_minreadct" (all samples rarefied to the overall minimum
...
rrarefy_variety <- function(otus,
                            metadata, 
                            method = c("even_minreadct", 
                                       "even_propminreadct", 
                                       "subj_minreadct"), 
                            prop = NULL) {
