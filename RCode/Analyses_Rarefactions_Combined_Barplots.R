...
longchg_all$Study[longchg_all$Study == "Student Microbiome Project (Gut)"] <- "SMP (Gut)"
p <- longchg_all %>% 
...
png(filename = paste0(pre, "Figures/combined_barplot_rarefy.png"), width = 2000, height = 1200)
p 
dev.off() 
