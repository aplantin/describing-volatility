...
# Moving Pictures 
mp_vol_all <- readRDS(paste0(pre, "VolSumms/mp_vol_all_rarefyP100.rds"))
...
smp_vol_all <- readRDS(paste0(pre, "VolSumms/smp_vol_all_rarefyP100.rds"))
...
# Gajer 
gaj_vol_all <- readRDS(paste0(pre, "VolSumms/gaj_vol_all_rarefyP100.rds"))
...
# Ravel 
rav_vol_all <- readRDS(paste0(pre, "VolSumms/rav_vol_all_rarefyP100.rds"))
